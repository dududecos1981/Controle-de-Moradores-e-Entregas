...
import { PrestadorServico, RegistroAcesso } from './types';

// Prestadores de Serviço Iniciais
export const INITIAL_PRESTADORES: PrestadorServico[] = [
  {
    ...
    empresa: 'EletroFix Manutenção & Instalações',
    especialidade: 'Eletricista',
    foto_url: 'https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?w=400&auto=format&fit=crop&q=80',
    placa_veiculo: 'ABC1D23',
    modelo_veiculo: 'Fiat Fiorino Branca',
    unidade_destino_bloco: 'B',
    unidade_destino_numero: 'PH01',
    morador_responsavel: 'Roberto Albuquerque (Síndico)',
    status_acesso: 'DENTRO',
    hora_entrada: '09:15',
    data_cadastro: new Date(Date.now() - 3600000 * 4).toISOString(),
    cracha_numero: 'CR-042',
    observacoes: 'Manutenção do quadro de disjuntores da cobertura. Autorizado até 17h.',
  },
  {
    id: 'prest-2',
    nome_completo: 'Marcos Vinícius Silva',
    cpf: '444.555.666-77',
    telefone: '(11) 96666-4444',
    empresa: 'Claro Telecom / Fibra Óptica',
    especialidade: 'Internet / Telecom',
    foto_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=80',
    placa_veiculo: 'TEL8E90',
    modelo_veiculo: 'VW Gol Prata',
    unidade_destino_bloco: 'A',
    unidade_destino_numero: '101',
    morador_responsavel: 'Mariana Fernandes',
    status_acesso: 'DENTRO',
    hora_entrada: '13:40',
    data_cadastro: new Date(Date.now() - 3600000 * 2).toISOString(),
    cracha_numero: 'CR-015',
    observacoes: 'Instalação de ponto adicional de fibra óptica no Apto 101.',
  },
  {
    id: 'prest-3',
    nome_completo: 'Antônio Jorge de Souza',
    cpf: '555.666.777-88',
    telefone: '(11) 95555-3333',
    empresa: 'HidroMaster Desentupidora & Encanamentos',
    ...
    placa_veiculo: 'HID3J45',
    modelo_veiculo: 'Renault Kangoo',
    unidade_destino_bloco: 'A',
    unidade_destino_numero: '201',
    morador_responsavel: 'Rodrigo Vasconcelos',
    status_acesso: 'CONCLUIDO',
    hora_entrada: '08:30',
    hora_saida: '11:45',
    data_cadastro: new Date(Date.now() - 3600000 * 8).toISOString(),
    cracha_numero: 'CR-008',
    observacoes: 'Reparo de vazamento no sifão da cozinha. Serviço finalizado com sucesso.',
  },
];

// Histórico de Últimos Acessos (Moradores, Visitantes e Prestadores)
export const INITIAL_ACESSOS: RegistroAcesso[] = [
  {
    ...
    data_hora: new Date(Date.now() - 1000 * 60 * 8).toISOString(), // Há 8 minutos
    metodo_validacao: 'TAG_VEICULAR',
    veiculo_placa: 'ABC1E23',
    veiculo_modelo: 'Jeep Compass',
    porteiro_responsavel: 'Portão Automático (LPR)',
  },
  {
    id: 'ac-2',
    ...
    foto_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=80',
    tipo_movimentacao: 'ENTRADA',
    data_hora: new Date(Date.now() - 1000 * 60 * 35).toISOString(), // Há 35 minutos
    metodo_validacao: 'PORTARIA_MANUAL',
    empresa: 'Claro Telecom / Fibra Óptica',
    servico_descricao: 'Instalação de Ponto de Internet',
    autorizado_por: 'Mariana Fernandes (Apto 101)',
    porteiro_responsavel: 'João Portaria',
    veiculo_placa: 'TEL8E90',
  },
  {
    id: 'ac-3',
    ...
    foto_url: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=400&auto=format&fit=crop&q=80',
    tipo_movimentacao: 'ENTRADA',
    data_hora: new Date(Date.now() - 1000 * 60 * 75).toISOString(), // Há 1h15
    metodo_validacao: 'QR_CODE',
    autorizado_por: 'Mariana Fernandes',
    porteiro_responsavel: 'João Portaria',
    veiculo_placa: 'BRA2E19',
    observacoes: 'Visita de familiar autorizada via App',
  },
  {
    id: 'ac-4',
    tipo_pessoa: 'PRESTADOR_SERVICO',
    ...
    foto_url: 'https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?w=400&auto=format&fit=crop&q=80',
    tipo_movimentacao: 'ENTRADA',
    data_hora: new Date(Date.now() - 1000 * 60 * 180).toISOString(), // Há 3h
    metodo_validacao: 'PORTARIA_MANUAL',
    empresa: 'EletroFix Instalações',
    servico_descricao: 'Manutenção Elétrica da Cobertura',
    autorizado_por: 'Roberto Albuquerque (Síndico)',
    porteiro_responsavel: 'João Portaria',
  ...
  },
  {
    ...
    data_hora: new Date(Date.now() - 1000 * 60 * 220).toISOString(),
    metodo_validacao: 'TAG_VEICULAR',
    veiculo_placa: 'VAS2C34',
    veiculo_modelo: 'Toyota Corolla Cross',
    porteiro_responsavel: 'Portão Automático (LPR)',
  },
  {
    id: 'ac-6',
    tipo_pessoa: 'PRESTADOR_SERVICO',
    nome: 'Antônio Jorge de Souza',
    documento: '555.666.777-88',
    unidade_bloco: 'A',
    unidade_numero: '201',
    foto_url: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&auto=format&fit=crop&q=80',
    tipo_movimentacao: 'SAIDA',
    data_hora: new Date(Date.now() - 1000 * 60 * 300).toISOString(),
    metodo_validacao: 'PORTARIA_MANUAL',
    empresa: 'HidroMaster Encanamentos',
    servico_descricao: 'Reparo hidráulico finalizado',
    autorizado_por: 'Rodrigo Vasconcelos',
    porteiro_responsavel: 'Carlos Plantão',
  },
  {
    id: 'ac-7',
    tipo_pessoa: 'MORADOR',
    ...
    foto_url: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&auto=format&fit=crop&q=80',
    tipo_movimentacao: 'ENTRADA',
    data_hora: new Date(Date.now() - 1000 * 60 * 360).toISOString(),
    metodo_validacao: 'BIOMETRIA_FACIAL',
    veiculo_placa: 'ROB8B88',
    veiculo_modelo: 'BMW 320i',
    porteiro_responsavel: 'Totem Facial Portaria 1',
  },
];
